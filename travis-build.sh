...
checkinstall -D -y \
	...
	--requires="libc6,libkf5configcore5,libkf5coreaddons5,libkf5i18n5,libkf5idletime5,libkf5kiocore5,libkf5notifications5,libkf5service5,mauikit-git \(\>= 2.1.1+git\),mauikit-filebrowsing-git \(\>= 2.1.1+git\),libqt5core5a,libqt5gui5,libqt5qml5,libqt5svg5,libqt5waylandcompositor5,libqt5widgets5,libstdc++6,qml-module-qt-labs-calendar,qml-module-qt-labs-platform" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
